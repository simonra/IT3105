...
public class BinaryMath {
	...
	// Må returne double, da double kan ha verdien
	...
	public static double findDifference(boolean[] minuend, boolean[] subtrahend) {
		...
		// Do twos complement again to get actual result (the difference is on
		// 2's complement form atm)
	...
	public static void subtractBinary(boolean[] binaryBoolean,
